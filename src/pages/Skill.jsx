...
import { FadeUp, FadeLeft, FadeRight, ScaleIn, FadeInUp } from "../animations/MotionComponents";

const Skill = () => {
  return (
    <div className="Skill relative bg-[#242734] w-full min-h-screen  font-display flex flex-col items-center ">
      <div className=" w-full flex pt-20 flex-col items-center">
        <FadeUp delay={0.3}><h1 className="md:text-6xl text-2xl text-white font-bold">
          My <span className="text-[#00c9cf] font-playful">Skills</span> & Tools
        </h1></FadeUp>

        <FadeUp delay={0.3}><p className="md:text-sm text-[8px] text-white/40 md:pt-5 pt-2 px-5 md:px-auto text-center">
      ...
      <div className=" w-full flex items-end justify-end gap-6 mt-2 md:mt-0 px-20">
        <FadeUp delay={0.3}><div className="flex items-center gap-2 text-[8px] md:text-sm font-light mt-2">
       ...
       <FadeUp delay={0.3}><div className="flex items-center gap-2 text-[8px] md:text-sm font-light">
      ...
      <FadeUp delay={0.3}><div className=" relative box-container w-auto grid md:grid-cols-5 grid-cols-3 md:gap-10 gap-2 gap-x-5 md:gap-x-14 mt-14   font-playful">
        <div className="boxes ">
      ...
      <FadeUp delay={0.3}><div className="w-[90%] h-36 items-center mt-10 grid grid-cols-4 md:flex md:flex-row justify-center md:gap-10 gap-5 md:text-lg text-[5px] text-white/60  ">
